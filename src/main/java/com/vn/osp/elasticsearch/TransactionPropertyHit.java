 ...
 */
public class TransactionPropertyHit {
    private Long _id;
    private String _index;
    private String _type;
    private Long _score;
    private TransactionProperty _source;

    @JsonCreator
    public TransactionPropertyHit(@JsonProperty(value = "_id", required = false) final Long _id,
                                  ...
                                  @JsonProperty(value = "_source", required = false) final TransactionProperty _source) {
        this._id = _id;
        this._index = _index;
        this._type = _type;
        this._score = _score;
    ...
    public TransactionProperty get_source() {
        return _source;
    }

    public void set_source(TransactionProperty _source) {
        this._source = _source;
    }
}
