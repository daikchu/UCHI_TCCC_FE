...
public class ContractTemplate{
  ...
  @JsonCreator
    public ContractTemplate(@JsonProperty(value = "contractTemplateId", required = false) final Long id,
                            @JsonProperty(value = "name", required = false) final String name,
                            @JsonProperty(value = "kind_id", required = false) final Long kind_id,
                            @JsonProperty(value = "kind_id_tt08", required = false) final Long kind_id_tt08,
                            ...
                            @JsonProperty(value = "relate_object_number", required = false) final Long relate_object_number,
                            ...
                            @JsonProperty(value = "period_flag", required = false) final Long period_flag,
                            @JsonProperty(value = "period_req_flag", required = false) final Long period_req_flag,
                            @JsonProperty(value = "mortage_cancel_func", required = false) final Long mortage_cancel_func,
                            @JsonProperty(value = "sync_option", required = false) final Long sync_option,
                            ...
                            @JsonProperty(value = "kind_html", required = false) final String kind_html,
