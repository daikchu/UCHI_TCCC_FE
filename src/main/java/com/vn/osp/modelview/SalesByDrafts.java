...
public class SalesByDrafts {
    ...
    public SalesByDrafts() {
    }

    public SalesByDrafts(String family_name, String first_name, Long numberContract, Long cost_tt91, Long cost_draft, Long cost_notary_outside, Long cost_other_determine, Long cost_total) {
