...
<script src="<%=request.getContextPath()%>/static/js/certificate/authenticatedCopies/report.js"
        type="text/javascript"></script>

<%--
    Báo cáo chứng thực bản sao
--%>

<spring:url value="/authenticatedCopies/list" var="listUrl"/>
<spring:url value="/certificate/export-copy-cert" var="exportUrl"/>

<script type="text/javascript">
    var url = '<%=SystemProperties.getProperty("url_config_server_api")%>';
    var contextPath = '<%=request.getContextPath()%>';
    var exportUrl = "/certificate/export-copy-cert";
    var userId = ${userId};
    var type = ${type};
    var userId = ${userId};
    $("#uchi-status").show();
...
<div id="menu-map">
    ...
    <span id="web-map">Sổ chứng thực bản sao</span>
</div>
<div class="truong-form-chinhds panel-group" ng-app="osp" ng-controller="AuthenticatedCopiesReportController">
        ...
        <div class="panel-body ">
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div id="rangeTime" hidden>
                                <div class="col-md-12" id="to-from">
                                    <div class="row">
                                        <div class="col-md-6">
                                            Từ ngày
            ...
            <div class="panel-body">
                <div class="report-contact" class="col-md-12">
                    <p id="report-title">SỔ CHỨNG THỰC BẢN SAO TỪ BẢN CHÍNH</p>
    ...
    <div class="panel-body truong-margin-footer0px">
        ...
        <table class="table" style="margin-bottom:0%" ng-switch on="listData.rowCount">
            ...
            <tr class="border-table">
                ...
                <th class=" ann-title border-table table-giua">Họ tên
            ...
            <tr ng-switch-default class="highlight-content"
                ...
                <td class="border-table truong-text-verticel" style="color: black;">
                    ...
                    <a ng-if="item.cert_request_user.length>100" data-trigger="click"
                ...
                <td class="border-table truong-text-verticel" style="color: black;">
                    ...
                    <a ng-if="item.cert_request_doc.length>100" data-trigger="click"
                       data-toggle="popover" data-html="true" data-placement="top"
                ...
                <td class="border-table align-giua breakAll">
                    ...
                    <a ng-if="item.note.length>100" data-trigger="click"
                       data-toggle="popover" data-html="true" data-placement="top"
...
<script>
    $(document).ready(function () {
        ...
        $(parentItem).click();
        $("#bao-cao-chung-thuc-ban-sao").addClass("child-menu");
    });
