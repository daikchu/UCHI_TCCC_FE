...
<script src="<%=request.getContextPath()%>/static/js/certificate/reportTT03CapTinh.js"
...
<script type="text/javascript">
    ...
    var exportUrl = "/reportCertificate/tt03-cap-tinh-export";
    var userId = ${userId};
    var districtCode = '${districtCode}';
    var level_cert_phongTuPhap = '${Constants.LEVEL_CERT_HUYEN}';
    var level_cert_Xa = '${Constants.LEVEL_CERT_XA}';
...
<div class="truong-form-chinhds panel-group" ng-app="osp" ng-controller="reportTT03CertCapTinhController">
        ...
        <div class="panel-body ">
            ...
            <div class="panel-body">
                <div class="report-contact" class="col-md-12">
                    <p id="report-title">KẾT QUẢ CHỨNG THỰC CỦA PHÒNG TƯ PHÁP VÀ ỦY BAN NHÂN DÂN (UBND) CẤP XÃ TRÊN ĐỊA
                        BÀN TỈNH</p>
    ...
    <div class="panel-body truong-margin-footer0px">
        ...
        <h4 class="font-bold">I. KẾT QUẢ CHỨNG THỰC TẠI CÁC PHÒNG TƯ PHÁP TRÊN ĐỊA BÀN TỈNH</h4>
        <table class="tbl-list truong-border-table col-md-12">
            ...
            <tr ng-repeat="item in reportTT03PhongTuPhaps">
                <td colspan="2" class="ann-title truong-border-table table-giua">Phòng Tư Pháp {{item.district_name}}</td>
        ...
        <table class="tbl-list truong-border-table col-md-12">
            ...
            <tr ng-repeat="item in reportTT03CapTinhCerts">
                <td colspan="2" class="ann-title truong-border-table table-giua">{{item.district_name}}
                </td>
                <td colspan="2" class="ann-title truong-border-table table-giua">{{item.cert_copies_number}}</td>
                <td colspan="2" class="ann-title truong-border-table table-giua">{{item.cert_signature_number}}</td>
                <td colspan="2" class="ann-title truong-border-table table-giua">{{item.cert_contract_number}}</td>
