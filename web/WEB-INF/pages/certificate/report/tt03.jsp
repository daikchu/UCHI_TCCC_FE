...
<script src="<%=request.getContextPath()%>/static/js/certificate/reportTT03.js"
        type="text/javascript"></script>

<%--
    Báo cáo chứng thực theo thông tư 03
--%>
<spring:url value="/reportCertificate/tt03" var="reportUrl"/>
...
<script type="text/javascript">
    ...
    var exportUrl = "/reportCertificate/tt03-export";
    var userId = ${userId};
...
<div class="truong-form-chinhds panel-group" ng-app="osp" ng-controller="reportTT03CertController">
        ...
        <div class="panel-body ">
            ...
            <div class="panel-body">
                <div class="report-contact" class="col-md-12">
                    <p id="report-title">KẾT QUẢ CHỨNG THỰC TẠI ỦY BAN NHÂN DÂN (UBND) CẤP XÃ</p>
    ...
    <div class="panel-body truong-margin-footer0px">
        ...
        <table class="tbl-list truong-border-table col-md-12">
            ...
            <tr>
                <td colspan="2" class="ann-title truong-border-table table-giua">{{reportTT03Cert.cert_copies_number}}</td>
                <td colspan="2" class="ann-title truong-border-table table-giua">{{reportTT03Cert.cert_signature_number}}</td>
                <td colspan="2" class="ann-title truong-border-table table-giua">{{reportTT03Cert.cert_contract_number}}</td>
            </tr>
        </table>
