...
<spring:url value="/report/export-contract-additional" var="exportUrl"/>
...
<%
    ...
    String chuyenViensoanThao_Name = checkcongchung.equals("1") ? "Người tiếp nhận hồ sơ" : "Chuyên viên soạn thảo";
%>
                                        ...
                                        <div class="col-md-9" id="to-from">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 truong-padding-delete">
                                                    <input type="text" value="${contractAdditionalWrapper.fromDate}" class="form-control date-time ${validate_msg_from_date != ""? "error_input":""}" name="fromDate" id="fromDate" >
                                                ...
                                                <div class="col-md-3 truong-padding-delete">
                                                    <input type="text" value="${contractAdditionalWrapper.toDate}" class="form-control date-time ${validate_msg_to_date != ""? "error_input":""}" name="toDate" id="toDate">
    ...
    <div class="panel-body truong-margin-footer0px">
        ...
        <table class="table" style="margin-bottom:0%">
            ...
            <tr class="border-table">
                <th class=" ann-title border-table table-giua truong-rstable-widthper15"><%=chuyenViensoanThao_Name%></th>
...
<script>
    $(document).ready(function () {
        ...
        $(parentItem).click();
        $("#bao-cao-theo-hd-bo-sung").addClass("child-menu");
