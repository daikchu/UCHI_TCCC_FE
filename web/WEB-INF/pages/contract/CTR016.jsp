...
--%>
<spring:url value="/report/by-draft" var="notaryUrl"/>
<spring:url value="/report/export-by-draft" var="exportUrl"/>
    ...
    <form class="form-horizontal" id="search-frm" action="${notaryUrl}" method="get">
        ...
        <div class="panel-body ">
            ...
            <div class="form-group">
                <label class="col-md-2 control-label  label-bam-trai text-nowrap">Chuyên viên soạn thảo</label>
                <div class="col-md-10">
                    <div class="row">
    ...
    <div class="panel-body truong-margin-footer0px">
        ...
        <table class="table" style="margin-bottom:0%">
            ...
            <tr class="border-table">
                <th class=" ann-title border-table table-giua truong-rstable-widthper12">Chuyên viên soạn thảo</th>
...
<script>
    $(document).ready(function () {
        ...
        $(parentItem).click();
        $("#bao-cao-theo-soan-thao").addClass("child-menu");
