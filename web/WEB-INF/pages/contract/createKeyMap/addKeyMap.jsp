...
<script src="<%=request.getContextPath()%>/static/js/contract/createKeyMap/addKeyMap.js" type="text/javascript"></script>
...
<div id="menu-map">
    ...
    <span id="web-map">Thêm mới từ khóa</span>
</div>
            ...
            <form name="myForm" class="panel panel-default" id="panel1">
                <div class="panel-heading col-md-12">
                    <div class="col-md-12" style="padding-left: 0px;">
                        <h4 class="panel-title col-md-9" style="padding-left: 0px;">Thông tin từ khóa</h4>
                        <div class="col-md-3">
                            <label class="control-label label-bam-trai">
                                <a target="_blank" href="<%=request.getContextPath()%>/contract/recommend-add-key-map-contract">
                                    <img class="truong-image-hd" src="<%=request.getContextPath()%>/static/image/Forma 6.png"> Hướng dẫn thêm từ khóa </a> </label>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6 control-label label-bam-trai">
                                    <label class="radio-inline prevent-type">
                                        <input ng-click="begin_or_close_(contract.begin_or_close);myFunc_();" type="radio" ng-model="contract.begin_or_close" value="1"
                                               ng-init="contract.begin_or_close = '0'" style="margin-top:0px">Bắt đầu
                                    </label>
                                    <label class="radio-inline">
                                        <input ng-click="begin_or_close_(contract.begin_or_close);myFunc_();" type="radio"
                                               ng-model="contract.begin_or_close" value="2" style="margin-top:0px">Kết thúc
                                    </label>
                                    <label class="radio-inline">
                                        <input ng-click="begin_or_close_(contract.begin_or_close);myFunc_();" type="radio"
                                               ng-model="contract.begin_or_close" value="0" style="margin-top:0px">Bỏ chọn
                                    </label>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Xác nhận thêm từ khóa? </p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" data-dismiss="modal" ng-click="addKeyMap()">Đồng ý</button>
