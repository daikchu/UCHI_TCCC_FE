...
<script src="<%=request.getContextPath()%>/static/js/contract/offline/contract.add.coppy.js"
...
<div class="truong-form-chinhbtt" ng-app="osp" id="contractOffAddCoppyController"
     ng-controller="contractOffAddCoppyController">
                ...
                <div class="panel-body">
                    ...
                    <c:if test="${SystemProperties.getProperty('org_type')==1}"> <%--Nếu là phường xã--%>
                        ...
                        <div class="row truong-inline-field">
                            <div class="form-group">
                                    <%--<div class="col-md-12">
                                        <label class="col-md-3 control-label label-bam-trai required">Người
                                            ký <%=congchung%>
                                        </label>
                                        <div class="col-md-3">
                                            <input type="text" class="form-control" name="contract.contract_signer"
                    ...
                    <div class="row truong-inline-field">
                        <div class="form-group">
                            <div class="col-md-3">
                                <label class="control-label  label-bam-trai">Tóm tắt nội dung</label>
                            </div>
                            <div class="col-md-9">
                                    ...
                                    <section class="panel panel-default"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control"
                                                               ...
                                                               id="change_registed_date{{itemIndex}}-{{$index}}" onkeypress="return restrictCharacters(this, event, forDate)"/>
                                                    </div>
                                                    <div class="col-md-3">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9" >
                                                        <input maxlength="200" type="text" class="form-control name"
                                                               ...
                                                               ng-keypress="getsuggestoff(itemIndex,$index);"
                                                               ng-paste="getsuggestoff(itemIndex,$index);"/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control"
                                                           ...
                                                           id="certification{{itemIndex}}-{{$index}}" onkeypress="return restrictCharacters(this, event, forDate);"/>
                                                </div>
                                                <div class="col-md-3">
                                        ...
                                        <div class="panel-body" ng-if="item1.template==3">
                                            <div id='parent_1'>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-3">
                                                        <label class="col-md-12 control-label  label-bam-trai">Điện
                                                            thoại</label>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-3">
                                                        <label class="col-md-12 control-label  label-bam-trai">Họ tên
                                                            người đại diện</label>
                                                    </div>
                                                        <div class="col-md-3">
                                                        ...
                                                        <div class="col-md-3">
                                                            <input maxlength="255" type="text" class="col-md-12 form-control fax"
                                                                   ng-model="item1.position"/>
                                                        </div>
                                                ...
                                                <div class="form-group" style="padding-right: 20px;padding-left: 20px">
                                                    ...
                                                    <div class="col-sm-9 input-group">
                                                        <input maxlength="50" type="text" class="form-control"
                                                               ...
                                                               ng-keypress="getsuggestpropertyoff($index,item.type);"
                                                               ng-paste="getsuggestpropertyoff($index,item.type);"/>
                        ...
                        <header class="panel-heading font-bold" style="margin-bottom: 20px;">
                            ...
                            <div class="btn-group  pull-right" style="margin-top:-25px;">
                                <button class="btn btn-primary btn-md dropdown-toggle " data-toggle="dropdown"><i
                                        class="fa fa-plus"></i>Thêm bên liên quan/tài sản<span class="caret"></span>
                                </button>
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a data-toggle="modal" ng-click="initPropertyInput()"
                                           data-target="#addPropertyDialog"><i class="fa fa-plus"></i>Tài sản</a>
                                    </li>
                                </ul>
                            </div>
                        </header>
                                ...
                                <section class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <form class="bs-example form-horizontal">
                                            ...
                                            <div class="form-group">
                                                <label class="col-lg-4 control-label label-bam-trai">Tên ngân
                                                    hàng</label>
                                                <div class="col-lg-8">
                                                    <select class="selectpicker select2 col-md-12 no-padding"
                                            ...
                                            <div class="form-group">
                                                <label class="col-lg-4 control-label label-bam-trai">Cán bộ tín
                                                    dụng</label>
                                                <div class="col-lg-8">
                                                    <input type="text" class="form-control"
                                ...
                                <section class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <form class="bs-example form-horizontal">
                                            ...
                                            <div class="form-group">
                                                <label class="col-lg-4 control-label label-bam-trai">Số
                                                    bản <%=congchung%>
                                                </label>
                                                <div class="col-lg-8">
                                                    <input type="text" class="form-control"
                                            ...
                                            <div class="form-group">
                                                <label class="col-lg-4 control-label label-bam-trai">File đính
                                                    kèm</label>
                                            ...
                                            <div class="form-group">
                                                <label class="col-lg-4 control-label label-bam-trai">Lưu trữ bản
                                                    gốc</label>
                                                <div class="col-lg-8">
                                                    <input type="text" class="form-control"
                                ...
                                <section class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <form class="bs-example form-horizontal">
                                            ...
                                            <div class="form-group">
                                                <label class="col-lg-4 control-label label-bam-trai">Thù
                                                    lao <%=congchung%>
                                                </label>
                                                <div class="col-lg-8">
                                                    <input type="text" class="form-control"
                                                           ng-model="contract.cost_draft"
                                                           ng-change="calculateTotal()"
                                                           onkeypress="return restrictCharacters(this, event, digitsOnly);"
                                                           format="number"/>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-lg-4 control-label label-bam-trai">Dịch
                                                    vụ <%=congchung%>
                                                    ngoài</label>
                                                <div class="col-lg-8">
                                                    <input type="text" class="form-control"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" ng-model="contract.cost_total"
                                                           class="form-control"
                                                           placeholder=""
                                                           onkeypress="return restrictCharacters(this, event, digitsOnly);"
                                                           format="number"/>
                    ...
                    <div ng-switch-when="true">
                        <div class="list-buttons" style="text-align: center;">
                            ...
                            <a data-toggle="modal" data-target="#addContract" class="btn btn-s-md btn-info">Cập nhật hợp
                                đồng</a>
                            <a data-toggle="modal" data-target="#addContractStore" class="btn btn-s-md btn-success">Lưu
                                tạm</a>
                            <%
                                }
                            %>
        ...
        <div class="modal fade" id="addContractStore" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer" ng-switch on="contract.kindhtml.length>0">
                        <div ng-switch-when="true">
                            <button type="button" class="btn btn-success" data-dismiss="modal"
                                    ng-click="temporaryOfflineAdd('true')">Đồng ý
                            </button>
                            <button type="button" class="btn btn-default" data-dismiss="modal">Hủy bỏ</button>
                        </div>
                        <div ng-switch-default>
                            <button type="button" class="btn btn-success" data-dismiss="modal"
                                    ng-click="temporaryOfflineAdd('false')">Đồng ý
                            </button>
                            <button type="button" class="btn btn-default" data-dismiss="modal">Hủy bỏ</button>
                        </div>
                    </div>
        ...
        <div class="modal fade" id="checkValidate" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Hãy nhập đủ thông tin vào các trường bắt buộc(có dấu <span
                                class="truong-text-colorred">*</span>)
                        </p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">OK</button>
                                ...
                                <li ng-repeat="(itemIndex,item) in privys.privy track by $index">
                                    ...
                                    <label ng-switch on="item.type" class="checkbox m-n i-checks pull-right">
                                        <label ng-switch-when="0" class="checkbox m-n i-checks pull-right"><input
                                                ...
                                                ng-click="checkRemoveActionPrivy($event,$index)"><i></i>Bỏ hiển thị tên
                                            bên
                                            liên quan</label>
                                            ...
                                            <div class="treeChild">
                                                ...
                                                <div class="col-md-12 panel-body ">
                                                    ...
                                                    <div ng-show="user.template==1 && user.myPerson"
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label  label-bam-trai">Họ và
                                                                tên</label>
                                                            <div class="col-md-4">
                                                            ...
                                                            <div class="col-md-4">
                                                                <input type="text" ng-model="user.birthday"
                                                                       class="form-control"
                                                                       id="userBirthday{{itemIndex}}-{{$index}}" onkeypress="return restrictCharacters(this, event, forDate)">
                                                            </div>
                                                        </div>

                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label  label-bam-trai">Giấy
                                                                CMND/Hộ chiếu/CCCD số</label>
                                                            <div class="col-md-4">
                                                                <input maxlength="50" type="text"
                                                                       ng-model="user.passport"
                                                                       class="form-control">
                                                    ...
                                                    <div ng-show="user.template==2 && user.myPerson"
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label  label-bam-trai">Đăng
                                                                kí
                                                                lần đầu ngày</label>
                                                            <div class="col-md-4">
                                                            ...
                                                            <label class="col-md-2 control-label  label-bam-phai">Đăng
                                                                kí
                                                    ...
                                                    <%--<div ng-show="user.template==3 && user.myPerson"
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label  label-bam-trai">Họ và
                                                                ...
                                                                người đại diện </label>
                                                            <div class="col-md-4">
                                                                <input maxlength="50" type="text" ng-model="user.name"
                                                                       class="form-control">
                                                            </div>
                                                            <label class="col-md-2 control-label  label-bam-phai">Chức
                                                                danh</label>
                                    ...
                                    <ul>
                                        <li ng-repeat="item in listProperty.properties track by $index">
                                            <div class="treeChild">
                                                ...
                                                &lt;%&ndash;<div class="col-md-7 col-md-offset-2">
                                                ...
                                                &lt;%&ndash;tự động chọn property khi load&ndash;%&gt;
                                                <div class="col-md-7 col-md-offset-2">
                                                    <select ng-model="item.template" class="form-control"
                                                            ng-change="changTemplateProperty($index,item.template)"
                                                            ng-options="temp1.id as temp1.name for temp1 in listTypeTaiSan">
                                                ...
                                                <div class="col-md-12 panel-body "
                                                    ...
                                                    <div class="bs-example form-horizontal ng-pristine ng-valid">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input maxlength="50" type="text"
                                                                       ...
                                                                       id="land_certificate{{$index}}"
                                                                       placeholder="Nhập số giấy chứng nhận để tìm kiếm"
                                                                       ng-keypress="getsuggestproperty($index,item.type,item.template);"
                                                                       ng-paste="getsuggestproperty($index,item.type,item.template);"/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label  label-bam-trai">Giấy
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label  label-bam-trai">Tổng
                                                                diện
                                                                tích sử dụng</label>
                                                            <div class="col-md-4">
                                                                <input type="text"
                                                            ...
                                                            <label class="col-md-2 control-label  label-bam-phai">Diện
                                                                tích
                                                                xây dựng</label>
                                                            <div class="col-md-4">
                                                                <input type="text"
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label  label-bam-trai">Kết
                                                                cấu
                                                                nhà </label>
                                                            <div class="col-md-10">
                                                        <textarea cols="3" ng-model="item.apartment.apartment_structure"
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label  label-bam-trai">Thửa
                                                                đất
                                                                số</label>
                                                            <div class="col-md-4">
                                                                <input maxlength="50" type="text"
                                                            ...
                                                            <label class="col-md-2 control-label  label-bam-phai">Tờ bản
                                                                đồ
                                                                số</label>
                                                            <div class="col-md-4">
                                                                <input maxlength="50" type="text"
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label  label-bam-trai">Sử
                                                                dụng
                                                                riêng</label>
                                                            <div class="col-md-4">
                                                                <input type="text"
                                                            ...
                                                            <label class="col-md-2 control-label  label-bam-phai">Sử
                                                                dụng
                                                                chung</label>
                                                            <div class="col-md-4">
                                                                <input type="text" ng-model="item.land.land_public_area"
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label  label-bam-trai">Mục
                                                                đích
                                                                sử dụng</label>
                                                            <div class="col-md-10">
                                                                <input type="text" ng-model="item.land.land_use_purpose"
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label  label-bam-trai">Thời
                                                                hạn
                                                                sử dụng</label>
                                                            <div class="col-md-10">
                                                                <input type="text" ng-model="item.land.land_use_period"
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label  label-bam-trai">Nguồn
                                                                gốc
                                                                sử dụng</label>
                                                            <div class="col-md-10">
                                                                <input type="text" ng-model="item.land.land_use_origin"
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label  label-bam-trai">Hạn
                                                                chế và
                                                                quyền sử dụng đất</label>
                                                            <div class="col-md-10">
                                                                <input type="text" ng-model="item.restrict"
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label  label-bam-trai">Thông
                                                                tin
                                                                khác</label>
                                                            <div class="col-md-10">
                                                                <input maxlength="1000" type="text"
                                                ...
                                                <div class="col-md-12 panel-body "
                                                    ...
                                                    <div class="bs-example form-horizontal ng-pristine ng-valid">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label  label-bam-trai">Tài
                                                                sản
                                                ...
                                                <div class="col-md-12 panel-body "
                                                    ...
                                                    <div class="bs-example form-horizontal ng-pristine ng-valid">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label  label-bam-trai">Loại
                                                                nhà
                                                                ở</label>
                                                            <div class="col-md-10">
                                                                <input type="text" ng-model="item.land.land_type"
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label  label-bam-trai">Hình
                                                                thức
                                                                sử dụng</label>
                                                            <div class="col-md-10">
                                                                <input type="text" ng-model="item.land.land_use_type"
                                                ...
                                                <div class="col-md-12 panel-body "
                                                    ...
                                                    <div class="bs-example form-horizontal ng-pristine ng-valid">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label  label-bam-trai">Biển
                                                                kiếm
                                                                soát </label>
                                                            <div class="col-md-10">
                                                                <input maxlength="50" type="text"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input maxlength="50" type="text" class="form-control name autocomplete_land_certificate{{$index}}" ng-model="item.land.land_certificate"
                                                                       id="land_certificate{{$index}}"   placeholder="Nhập số giấy chứng nhận để tìm kiếm" ng-keypress="getsuggestproperty($index,item.type);" ng-paste="getsuggestproperty($index,item.type);"  />
                                                ...
                                                <div class="col-md-12 panel-body " ng-show="item.type=='01' && item.template=='1' && item.myProperty" >
                                                    ...
                                                    <div class="bs-example form-horizontal ng-pristine ng-valid">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <label class="col-md-2 control-label  label-bam-trai">Diện tích bằng chữ </label>
                                                            <div class="col-md-4">
                                                                <input maxlength="255" type="text" ng-model="item.land.land_area_text" class="form-control">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input maxlength="500" type="text" ng-model="item.owner_info" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label  label-bam-trai">Thông tin khác</label>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input maxlength="50" type="text" class="form-control name autocomplete_car_frame_number{{$index}}" ng-model="item.vehicle.car_frame_number"
                                                                       id="car_frame_number{{$index}}" placeholder="Nhập số khung để tìm kiếm" ng-keypress="getsuggestproperty($index,item.type);" ng-paste=""  />
                                                                <span class="truong-warning-text" ng-show="item.land.land_street == '1'">Tài sản này đang được cảnh bảo từ thông tin ngăn chặn trên cơ sở dữ liệu của Sở</span>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                ...
                                                <div class="col-md-12 panel-body "
                                                    ...
                                                    <div class="bs-example form-horizontal ng-pristine ng-valid">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input maxlength="1000" type="text" ng-model="item.owner_info"
                                                                       class="form-control">
                                                            </div>
                                                        </div>
    ...
    <script>
        ...
        $('#addPropertyDialog').on('shown.bs.modal', function () {
            ...
            angular.element(document.getElementById('contractOffAddCoppyController')).scope().setDateProperty();
        });
        $('#addPrivysDialog').on('shown.bs.modal', function () {
            // will only come inside after the modal is shown

            angular.element(document.getElementById('contractOffAddCoppyController')).scope().setDatePrivy();
        });
