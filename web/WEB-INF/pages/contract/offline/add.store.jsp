...
<div id="menu-map">
    ...
    <span id="web-map">Chi tiết hợp đồng lưu tạm</span>
</div>
            ...
            <form class="panel panel-default" name="myForm" id="panel1">
                ...
                <div class="panel-body">
                    ...
                    <div class="row truong-inline-field">
                        <div class="form-group">
                            <div class="col-md-6">
                                <label class="col-md-6 control-label  label-bam-trai required">Số <%=hopDong%>
                                </label>
                                <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-3" style="padding: 0 30px 0 7px;">
                                    ...
                                    <select ng-model="contract.notary_book" id="notary_book_valid" name="notary_book" class="selectpicker select2 col-md-12 no-padding"
                                             required>
                                        <option <%--value="2"--%>>--Chọn sổ <%=congchung%>--</option>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <input maxlength="255" type="text" class="form-control"
                                               ng-model="contract.request_recipient">
                                    </div>
                                </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <%--<select class="col-sm-12 control-label  label-bam-trai"
                                                            ...
                                                            <select class="col-sm-12 control-label  label-bam-trai"
                                                                    ng-options="option.name for option in dataSelectedSex.availableOptions track by option.id"
                                                                    ng-model="item1.sex"
                                                            <%--ng-init="item1.sex.id = 2; item1.sex.name = 'Bà'"--%>>
                                                                <%--<option ng-repeat="option in dataSelectedSex.availableOptions" ng-value="option.id">{{option.name}}</option>--%>
                                                            </select>
                                                    </div>
                                                    <div class="col-sm-9">
            ...
            <div class="panel-body" ng-switch on="contract.kindhtml.length>0">
                <div ng-switch-when="true">
                    <div class="list-buttons" style="text-align: center;">
                        ...
                        %>
                        <a data-toggle="modal" data-target="#addContract" class="btn btn-s-md btn-info">Đăng tải hợp
                            đồng</a>
                        <a href="<%=request.getContextPath()%>/contract/temporary/addCoppy/${contract.id}"
                        ...
                        %>
                        <a data-toggle="modal" data-target="#_deleteContract" class="btn btn-s-md btn-danger">Xóa hợp
                            đồng</a>
                        <%
                            }
                        %>
                ...
                <div ng-switch-default>
                    <div class="list-buttons" style="text-align: center;">
                        ...
                        <a href="<%=request.getContextPath()%>/contract/addContractOfflineTemporary/restore/${contract.id}"
                           class="btn btn-s-md btn-info">Sao chép HĐ</a>
                        <%
                            }
                        %>
    ...
    <div class="modal fade" id="editContract" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Lưu hợp đồng</h4>
                </div>
                <div class="modal-body">
                    <p>Xác nhận lưu hợp đồng? </p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" data-dismiss="modal" ng-click="editContractWrapper()">
                        Đồng ý
                    </button>
                    <button type="button" class="btn btn-default" data-dismiss="modal">Hủy bỏ</button>
                </div>
