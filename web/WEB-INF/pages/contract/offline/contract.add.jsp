                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-3">
                                    ...
                                    &lt;%&ndash;<span class="truong-text-colorred"  ng-show="myForm.notary_id.$touched && myForm.notary_id.$invalid">Trường không được bỏ trống.</span>&ndash;%&gt;
                                </div>
                            </div>
                        ...
                        <div class="row truong-inline-field">
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <label class="col-md-3 control-label label-bam-trai" id="div_CVST">Chuyên viên soạn
                                        thảo</label> <%--hiển thị nếu là tổ chức công chứng--%>
                                    <div class="col-md-3" id="div_CVST1">
                                    ...
                                    <label class="col-md-3 control-label required"><%=congchungH%>
                                        viên</label>
                                    <div class="col-md-3">
                                        <select name="notary_id" ng-model="contract.notary_id"
                                                class="selectpicker select2 col-md-12 no-padding" required>
                                            <option value="">--Chọn <%=congchung%> viên--</option>
                                            <option ng-repeat="item in notarys" value="{{item.userId}}">
                                                {{item.family_name}} {{item.first_name}}
                                            </option>
                                        </select>
                                        <span class="truong-text-colorred">{{notary_id_}}</span>
                    ...
                    <section class="panel panel-default" ng-repeat="(itemIndex,item) in privys.privy track by $index">
                        ...
                        <div class="panel-body">
                            <section class="panel panel-default" ng-repeat="item1 in item.persons track by $index">
                                    ...
                                    <div class="pull-right">
                                        ...
                                        <%-- <div class="btn-group" style="margin-top:-8px;margin-right:15px;">
                                         <button class="btn btn-primary btn-sm dropdown-toggle "
                                                 ng-click="showDetailsPrivy= !showDetailsPrivy">
                                             <div ng-switch on="showDetailsPrivy">
                                                 ...
                                                 <a class="pull-right" data-toggle="tooltip" title="Xóa bên đương sự"
                                                    style="background-image:none;"><i class="fa fa-trash-o"
                                                                                      ng-click="removePerson(itemIndex,$index)"
                                                                                      style="font-size:20px;color:red;"></i></a>
                                         </div>--%>
                                ...
                                <%--<div class="panel-body" ng-show="!showDetailsPrivy">
                                    <div class="form-group" style="padding-right: 20px;padding-left: 20px">
                                        <label class="col-sm-3 control-label label-bam-trai">Thông tin đương sự</label>
                                        <div class="col-sm-9 input-group">
                                        <textarea maxlength="1000" class="form-control" rows="5" name="privyInfo"
                                                  ng-model="item.privy_info"></textarea>
                                        </div>
                                    </div>
                                </div>--%>
                                ...
                                <div class="panel-body" ng-switch on="item1.template==2"
                                    ...
                                    <div ng-switch-default>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-3">
                                                ...
                                                <select ng-init="item1.sex.id = 1; item1.sex.name = 'Ông'"
                                                        class="col-sm-12 control-label  label-bam-trai"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9" style="padding-right: 30px;">
                                            <input maxlength="50" type="text" class="form-control passport"
                                                   ng-model="item1.passport"/>
                                            <span class="truong-text-colorred" id="CMT-{{itemIndex}}-{{$index}}" hidden>CMND/Hộ chiếu/CCCD không chứa ký tự đặc biệt</span>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control certification_date" autocomplete="off"
                ...
                <div class="panel-body">
                    <section class="panel panel-default" ng-repeat="item in listProperty.properties track by $index">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group" style="padding-right: 20px;padding-left: 20px">
                                ...
                                <div class="col-md-4">
                                    <select ng-model="item.template" class="form-control"
                                            ...
                                            &lt;%&ndash;ng-init="item.template = getList($index)[0].id"&ndash;%&gt;>

                                        &lt;%&ndash;<option ng-if="index2>0" ng-repeat="item1 in getList($index) track by $index2" value="{{item1.id}}">
                                            {{item1.name}}
                                        </option>&ndash;%&gt;
                            ...
                            <div ng-show="showDetails">
                                &lt;%&ndash;<div ng-show="item.type=='01'">
                                    <div class="form-group" style="padding-right: 20px;padding-left: 20px">
                                        ...
                                        <div class="col-sm-9 input-group">
                                            ...
                                            <!--code bổ sung link đến thông tin ngăn chặn khi bị cảnh báo tại màn hình soạn thảo hđ-->
                                            <span class="truong-warning-text" ng-show="item.land.land_street == '1'">
												Tài sản này đang được cảnh bảo từ thông tin ngăn chặn trên cơ sở dữ liệu của Sở
												<a href="<%=request.getContextPath()%>/transaction/search?stringKey=%22{{item.land.land_certificate}}%22"
                                                   target="_blank" style="color: #0123c2;font-weight: 700;">
													Xem chi tiết
												</a>
											</span><!--End code cảnh báo-->
                                        </div>
                                ...
                                &lt;%&ndash; chú thích bắt đầu tài sản phương tiện tàu bay&ndash;%&gt;
                                <div class="col-md-12 panel-body "
                                     ng-show="item.type=='02' && item.template=='11' && item.myProperty">

                                    <div class="bs-example form-horizontal ng-pristine ng-valid">
                                        &lt;%&ndash; <h3><b>THÔNG TIN TÀI SẢN TÀU BAY</b></h3>&ndash;%&gt;
                                        <div class="form-group">
                                            <label class="col-md-2 control-label  label-bam-trai">Tìm
                                                kiếm</label>
                                            <div class="col-md-10">
                                    ...
                                    &lt;%&ndash; chú thích bắt đầu tài sản phương tiện thủy nội địa&ndash;%&gt;
                                    <div class="col-md-12 panel-body "
                                         ng-show="item.type=='02' && item.template=='12' && item.myProperty">

                                        <div class="bs-example form-horizontal ng-pristine ng-valid">
                                            &lt;%&ndash; <h3><b>THÔNG TIN TÀI SẢN PHƯƠNG TIỆN THỦY NỘI ĐỊA</b></h3>&ndash;%&gt;
                                            <div class="form-group">
                                                <label class="col-md-2 control-label  label-bam-trai">Tìm
                                                    kiếm</label>
                                                <div class="col-md-10">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input maxlength="200" type="text" ng-model="item.vehicle_ship.ship_year_place_construction"
                                                               class="form-control">
                                                    </div>
                                                </div>
                                ...
                                &lt;%&ndash;<div ng-show="item.type=='02'">
                                ...
                                &lt;%&ndash;<div ng-show="item.type=='99'">
                                    <div class="form-group" style="padding-right: 20px;padding-left: 20px">
    ...
    <div class="modal fade" id="checkValidate" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Thông tin thiếu hoặc chưa hợp lệ!</h4>
                </div>
                <div class="modal-body">
...
<script>
    ...
    <%--$(document).ready(function () {--%>
    <%--    var org_type = '<%=SystemProperties.getProperty("org_type")%>';--%>
    <%--    if (org_type == "1") {//is not to chuc cong chung--%>
    <%--        $('#div_CVST').hide();--%>
    <%--        $('#div_CVST1').hide();--%>
    <%--        /!*   $('#div_HuyenPx').hide();*!/--%>
    <%--    }--%>
