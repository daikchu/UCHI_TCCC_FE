                    ...
                    <span class="input-group-btn ">
                         <button class="btn btn-primary btn-sm" style="margin-left:10px;"
                             ...
                             <div ng-switch on="showDetails">
                                  <div ng-switch-when=true><a style="color:white;">Thông tin đơn giản</a></div>
                    ...
                    <div class="col-md-12 panel-body "
                        ...
                        <div class="bs-example form-horizontal ng-pristine ng-valid">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input maxlength="50" type="text"
                                           ...
                                           ng-keypress="getsuggestproperty($index,item.type);"
                                           ng-paste="getsuggestproperty($index,item.type);" autocomplete="off"/>
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-md-2 control-label  label-bam-phai">Vào sổ cấp giấy chứng nhận
                                    số</label>
                                <div class="col-sm-4">
                                    <input maxlength="50" type="text"
