...
<script type="text/javascript">
    ...
    var notaryBook = '${contract.notary_book}';
</script>
<%
...
<script src="<%=request.getContextPath()%>/static/js/contract/offline/add.store.js" type="text/javascript"></script>
...
<div class="truong-form-chinhbtt" ng-app="osp" id="contractOffAddStoreController"
     ng-controller="contractOffAddStoreController">
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6" style="padding-left: 7px !important;">
                                    <select id="contractKindValue_valid"
                    ...
                    <div class="row truong-inline-field">
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6" style="padding-left: 7px !important;">
                                    <select id="contract_template_id_valid"
                                            class="selectpicker select2 col-md-12 no-padding"
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-3" style="padding-left: 7px !important;">
                                    <input id="contract_number_valid" type="text" class="form-control"
                                           name="contract.contract_number" ng-model="contract.contract_number"
                                           required/>
                                    <span class="truong-text-colorred">{{contract_number_valid}}</span>
                                </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <c:if test="${SystemProperties.getProperty('org_type')==1}"> <%--neu la phường xã--%>
                                    <label class="col-md-3 control-label  label-bam-trai required">Sổ <%=congchung%></label>
                                </c:if>
                                <c:if test="${SystemProperties.getProperty('org_type')==0}"> <%--neu la tccc--%>
                                    <label class="col-md-3 control-label  label-bam-trai ">Sổ <%=congchung%></label>
                                </c:if>
                                <div class="col-md-3" style="padding: 0 30px 0 7px;">
                                    <select id="notary_book_valid" name="notary_book" class="selectpicker select2 col-md-12 no-padding"
                                            ng-model="contract.notary_book" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="received_date"
                                           ...
                                           required/>
                                    <span class="truong-text-colorred">{{received_date_valid}}</span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="col-md-6 ">
                                    <input type="text" class="form-control" name="notary_date"
                                           ...
                                           maxlength="10" onkeypress="return restrictCharacters(this, event, forDate);"
                                           required/>
                                    <span class="truong-text-colorred">{{notary_date_valid}}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select id="drafter_id_valid" class="selectpicker select2 col-md-12 no-padding"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <select id="notary_id_valid" class="selectpicker select2 col-md-12 no-padding"
                                    ...
                                    <div class="pull-right" style="margin-right:-25px;">
                                        <div class="btn-group" style="margin-top:-8px;margin-right:15px;">
                                            <button class="btn btn-primary btn-sm dropdown-toggle "
                                                    data-toggle="dropdown"><i class="fa fa-plus"></i>Đương sự<span
                                    ...
                                    <section class="panel panel-default"
                                        ...
                                        <header class="panel-heading font-bold" style="margin-bottom: 20px;">
                                            ...
                                            <div class="pull-right">
                                                <a data-toggle="tooltip" title="Xóa cá nhân/tổ chức này"
                                                   style="background-image:none;"><i class="fa fa-trash-o"
                                    ...
                                    <div ng-show="showDetails">
                                        <div ng-show="item.type=='01'">
                                            ...
                                            <div class="form-group" style="padding-right: 20px;padding-left: 20px">
                                                ...
                                                <div class="col-sm-9 input-group">
                                                    <input type="text" class="form-control" ng-model="item.land.construction_area"   />
                                                </div>
                                            </div>
                                            <div class="form-group" style="padding-right: 20px;padding-left: 20px">
                                        ...
                                        <div class="form-group" style="padding-right: 20px;padding-left: 20px">
                                            ...
                                            <div class="col-sm-9 input-group">
                                                <input maxlength="500" type="text" class="form-control" ng-model="item.owner_info"   />
                                            </div>
                                        </div>
                                        <div class="form-group" style="padding-right: 20px;padding-left: 20px">
                            ...
                            <div class="btn-group  pull-right" style="margin-top:-25px;">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a data-toggle="modal" ng-click="initPrivyInput()"
                                           data-target="#addPrivysDialog"><i class="fa fa-plus"></i>Bên liên quan</a></li>
                                    <li><a data-toggle="modal" ng-click="initPropertyInput()"
                                           data-target="#addPropertyDialog"><i class="fa fa-plus"></i>Tài sản</a></li>
                                </ul>
                            </div>
                        </header>
                        <div class="panel-body">
            ...
            <div class="panel-body" ng-switch on="contract.kindhtml.length>0">
                <div ng-switch-when="true">
                    <div class="list-buttons" style="text-align: center;">
                        ...
                        %>
                        <a data-toggle="modal" data-target="#restoreAddContract" class="btn btn-s-md btn-info">Cập nhật
                            hợp đồng</a>
                        <%--<a data-toggle="modal"  data-target="#restoreTemporaryOfflineAdd"  class="btn btn-s-md btn-info">Lưu tạm</a>--%>
                        <%
                            }
                        %>
                        ...
                        <a href="<%=request.getContextPath()%>/contract/list" class="btn btn-s-md btn-default">Hủy
                            bỏ</a>
                    </div>
                </div>
                <div ng-switch-default>
    ...
    <div class="modal fade" id="restoreAddContract" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" data-dismiss="modal" ng-click="restoreAddContract()">
                        Đồng ý
                    </button>
    ...
    <div class="modal fade" id="restoreTemporaryOfflineAdd" role="dialog">
        <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" data-dismiss="modal"
                            ng-click="restoreTemporaryOfflineAdd()">Đồng ý
                    </button>
                    <button type="button" class="btn btn-default" data-dismiss="modal">Hủy bỏ</button>
                </div>
            </div>
            ...
            <div class="modal-content" style="width:900px;">
                ...
                <div class="modal-body">
                    <div class="tree well">
                        <ul>
                            <li ng-repeat="(itemIndex,item) in privys.privy track by $index">
                                <span class="spanText"><i class="icon-folder-open"></i>
                                    Bên <label ng-model="item.action" editspan="item.action" class="inputcontract"
                                               contenteditable="true" style="font-size: 15px !important;">{{item.action}}</label> (sau đây gọi là {{item.name}}):
                                </span>
                                                ...
                                                <div ng-show="user.template==1 && user.myPerson"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="col-sm-12 control-label  label-bam-trai"
                                                                ng-options="option.name for option in dataSelectedSex.availableOptions track by option.id"
                                                                ng-model="user.sex"
                                                                <%--ng-init="user.sex.id = 1; user.sex.name = 'Ông'"--%>>
                                                        </select>
                                                        <div class="col-md-4">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input type="text" ng-model="item.land.land_issue_date"
                                                                   class="form-control" id="landIssueDate{{$index}}" onkeypress="return restrictCharacters(this, event, forDate)">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label  label-bam-trai">Địa
                                            ...
                                            <div class="col-md-12 panel-body "
                                                ...
                                                <div class="bs-example form-horizontal ng-pristine ng-valid">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input type="text" ng-model="item.land.land_issue_date"
                                                                   class="form-control" id="landIssueDate2{{$index}}" onkeypress="return restrictCharacters(this, event, forDate)">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-12 panel-body "
                                                ...
                                                <div class="bs-example form-horizontal ng-pristine ng-valid">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input type="text" ng-model="item.land.land_issue_date"
                                                                   class="form-control" id="landIssueDate3{{$index}}" onkeypress="return restrictCharacters(this, event, forDate)">
                                                        </div>
                                                    </div>
...
<script>
    ...
    $('#addPropertyDialog').on('shown.bs.modal', function () {
        ...
        angular.element(document.getElementById('contractOffAddStoreController')).scope().setDateProperty();
    });
    $('#addPrivysDialog').on('shown.bs.modal', function () {
        // will only come inside after the modal is shown

        angular.element(document.getElementById('contractOffAddStoreController')).scope().setDatePrivy();
    });
