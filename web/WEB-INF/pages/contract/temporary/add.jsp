...
<script src="<%=request.getContextPath()%>/static/js/contract/temporary/temporary.add.js"
...
<div class="truong-form-chinhbtt" ng-app="osp" id="contractAddController" ng-controller="contractAddController">
    ...
    <div class="panel-group" id="accordion">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <select name="notary_book_valid" ng-model="contract.notary_book"
                                        ...
                                        <option value="">--Chọn sổ công chứng--</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="received_date"
                                           ...
                                           onkeypress="return restrictCharacters(this, event, forDate);" autocomplete="off"/>
                                    <c:if test="${SystemProperties.getProperty('org_type')==1}"> <%--neu la phường xã--%>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="text" class="form-control" ng-model="contract.cost_tt91"
                                                   ng-change="calculateTotal();checkphi(contract.cost_tt91);"
                                                   format="number"
                                                   onkeypress="return restrictCharacters(this, event, digitsOnly);" />
                                        </div>
        ...
        <div class="panel-body" style="text-align: center;">
            ...
            <a data-toggle="modal" data-target="#updateContractTemplate" ng-dissable="checkLoad"
               class="btn btn-s-md btn-success">Lưu làm mẫu</a>
            <a href="<%=request.getContextPath()%>/contract/temporary/list" class="btn btn-s-md btn-default">Hủy
                bỏ</a>
    ...
    <div class="modal fade" id="markContract" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Xác nhận hợp đồng được lưu ? </p>
                </div>
                <div class="modal-footer">
