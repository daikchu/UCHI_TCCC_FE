...
<script src="<%=request.getContextPath()%>/static/js/contract/temporary/detail.mark.js" type="text/javascript"></script>
...
<div class="truong-form-chinhbtt" ng-app="osp" ng-controller="temporaryDetailMarkController">

    <div id="uchi-status">
        <c:if test="${statusLoad==1}">
            <div class="status-success"><img class="status-img"
                                             src="<%=request.getContextPath()%>/static/image/success.png">Ký hợp đồng
                thành công!
            </div>
        </c:if>
    </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="row truong-inline-field">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control truong-opacity-07" name="contractKind.name"
                    ...
                    <div class="row truong-inline-field">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control truong-opacity-07" name="contractTemplate.name"
                    ...
                    <div ng-show="contractTemplatesApiece != '' && contractTemplatesApiece != null">
                        <div class="row truong-inline-field">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control truong-opacity-07"
                                           name="contractTemplatesApiece.name" ng-model="contractTemplatesApiece.name"
                                           disabled="true"/>
                                </div>
                            </div>
                        </div>
                    ...
                    <%--                    <div class="row truong-inline-field">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" name="contract.contract_number"  ng-model="contract.contract_number"  />
                                                </div>
                    ...
                    <div class="row truong-inline-field">
                        <div class="form-group">
                            ...
                            <div class="col-md-3 ">
                                <input type="text" class="form-control" ng-model="contract.notary_date"
                                       id="notaryDate"/>
                            </div>
                    ...
                    <c:if test="${SystemProperties.getProperty('org_type')==0}"> <%--neu la to chuc cong chung--%>
                        <div class="row truong-inline-field">
                            <div class="form-group ">
                                ...
                                <div class="col-md-3 truong-opacity-07">
                                    <select class="selectpicker select2 col-md-12 no-padding truong-opacity-07"
                    ...
                    <div class="row truong-inline-field">
                        <div class="form-group">
                            ...
                            <div class="">
                                ...
                                <div class="col-md-9">
                                    <textarea maxlength="1000" class="form-control truong-opacity-07"
                                              name="contract.summary" ng-model="contract.summary"
                    ...
                    <div class="row truong-inline-field">
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control truong-opacity-07" name="contract.contract_value"
                ...
                <div class="list-buttons" style="text-align: center;">
                    <div ng-switch on="contract.type">
                        ...
                        <div ng-switch-when=1>
                            ...
                            %>
                            <a href="<%=request.getContextPath()%>/contract/temporary/list#daky"
    ...
    <div class="modal fade" id="notContractNumber" role="dialog">
        <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Chưa lấy số hợp đồng!</h4>
                </div>
                <div class="modal-body">
                    <p>Hợp đồng của bản chưa lấy số. Bạn hãy lấy số hợp đồng. </p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">OK</button>
                </div>
    ...
    <div class="modal fade" id="errorNotaryDate" role="dialog">
        <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <p>Trước khi ký phải chọn ngày <%=congchung%>. Hãy chọn Chỉnh sửa để hoàn thiện thông tin cần thiết
                        cho hợp đồng </p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">OK</button>
