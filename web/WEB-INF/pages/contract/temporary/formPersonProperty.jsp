    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content" style="width:900px;">
            <div class="modal-header">
                ...
                <button class="btn btn-s-md btn-primary pull-left " ng-click="addPrivy()" type="button">Thêm bên liên
                    quan
                </button>
            </div>
                ...
                <div class="tree well">
                    <ul>
                        <li ng-repeat="(itemIndex,item) in privys.privy track by $index">
                            ...
                            <a class="btn btn-sm btn-primary " ng-click="addPerson($index)"><i class="fa fa-plus"></i>Thêm
                                cá nhân/tổ chức tham gia</a>
                            ...
                            <label ng-switch on="item.type" class="checkbox m-n i-checks pull-right">
                                <label ng-switch-when="0" class="checkbox m-n i-checks pull-right"><input
                                        ...
                                        ng-click="checkRemoveActionPrivy($event,$index)"><i></i>Bỏ hiển thị tên bên liên
                                    quan</label>
                                    ...
                                    <div class="treeChild">
                                        ...
                                        <div class="col-md-7 " style="padding-top: 7px">
                                            ...
                                            <select ng-model="user.template" class="form-control"
                                                    ...
                                                    ng-init="changTemplatePrivy(itemIndex,$index,user.template)"
                                        ...
                                        <div class="col-md-3" style="padding-top: 7px">
                                            ...
                                            <a class="btn btn-sm btn-danger " ng-click="removePerson(itemIndex,$index)"><i
                                                    class="fa fa-trash-o"></i>Xóa</a>
                                        </div>
                                        ...
                                        <div class="col-md-12 panel-body ">
                                            ...
                                            <div ng-show="user.template==1 && user.myPerson"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="col-md-2 control-label  label-bam-trai"
                                                            ...
                                                            ng-model="user.sex" <%--ng-init="user.sex.id = 1; user.sex.name = 'Ông'"--%>>
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label  label-bam-trai">Giấy CMND/Hộ
                                                        chiếu/CCCD số</label>
                                                    <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input maxlength="100" type="text"
                                                               ng-model="user.certification_place" class="form-control">
                                                    </div>
                                                </div>
                                            ...
                                            <div ng-show="user.template==2 && user.myPerson"
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label  label-bam-trai">Tên công
                                                        ty </label>
                                                    <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label  label-bam-trai">Địa chỉ công
                                                        ty </label>
                                                    <div class="col-md-10">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label  label-bam-trai">Đăng kí lần
                                                        đầu ngày</label>
                                                    <div class="col-md-4">
                                                    ...
                                                    <label class="col-md-2 control-label  label-bam-phai">Đăng kí thay
                                                        đổi lần thứ </label>
                                                    <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label  label-bam-trai">Ngày đăng kí
                                                        thay đổi </label>
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input maxlength="100" type="text"
                                                               ng-model="user.department_issue" class="form-control">
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <label class="col-md-2 control-label  label-bam-trai">Họ tên người
                                                        đại diện </label>
                                                    <div class="col-md-4">
                                                        <input maxlength="200" type="text" ng-model="user.name"
                                                               class="form-control">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label  label-bam-trai">CMND/Hộ
                                                        chiếu/CCCD số </label>
                                                    <div class="col-md-4">
                                                        <input maxlength="50" type="text" ng-model="user.passport"
                                                               class="form-control">
                                            ...
                                            <div ng-show="user.template==3 && user.myPerson"
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label  label-bam-trai">Mã số doanh
                                                        nghiệp </label>
                                                    <div class="col-md-10">
                                                        <input maxlength="100" type="text" ng-model="user.org_code"
                                                               class="form-control">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label  label-bam-trai">Địa chỉ trụ sở
                                                        chính </label>
                                                    <div class="col-md-10">
                                                        <input maxlength="255" type="text" ng-model="user.org_address"
                                                               class="form-control">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label  label-bam-trai">Đơn vị trực
                                                        tiếp quản lý khách hàng </label>
                                                    <div class="col-md-10">
                                ...
                                <li ng-repeat="item in listProperty.properties track by $index">
                                    <div class="treeChild">
                                        <div class="col-md-2" ng-click="showProperty($index)">
                                            <a class="btn btn-success btn-sm"><i class="icon-folder-open"></i> Tài sản
                                                {{$index+1}}: </a>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <a class="btn btn-sm  btn-danger deleteTree"
                                               ng-click="removeProperty($index)"><i class="fa fa-trash-o"></i>Xóa </a>
                                        </div>
                                        ...
                                        <div class="col-md-12 panel-body "
                                            ...
                                            <div class="bs-example form-horizontal ng-pristine ng-valid">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-md-2 control-label  label-bam-phai">Vào sổ cấp
                                                        giấy chứng nhận số</label>
                                                    <div class="col-md-4">
                                                        <input maxlength="50" type="text"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <textarea maxlength="200" cols="3"
                                                                  ng-model="item.apartment.apartment_structure"
                                                                  class="form-control"
                                                                  rows="2"></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input maxlength="255" type="text"
                                                               ng-model="item.land.land_area_text" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input maxlength="100" type="text"
                                                               ng-model="item.land.land_use_purpose"
                                                               class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input maxlength="200" type="text"
                                                               ng-model="item.land.land_use_origin"
                                                               class="form-control">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-12 panel-body "
                                            ...
                                            <div class="bs-example form-horizontal ng-pristine ng-valid">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input maxlength="255" type="text"
                                                               ng-model="item.land.land_type" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input maxlength="255" type="text"
                                                               ng-model="item.land.building_area" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input maxlength="255" type="text"
                                                               ng-model="item.land.land_use_type" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input maxlength="255" type="text"
                                                               ng-model="item.land.land_sort" class="form-control">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-12 panel-body "
                                            ...
                                            <div class="bs-example form-horizontal ng-pristine ng-valid">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label  label-bam-trai">Kiểu
                                                        loại </label>
                                                    <div class="col-md-4">
                                                        <input maxlength="200" type="text"
                                                    ...
                                                    <label class="col-md-2 control-label  label-bam-phải">Số động
                                                        cơ </label>
                                                    <div class="col-md-4">
                                                        <input maxlength="200" type="text"
                                                               ng-model="item.vehicle_airplane.airplane_engine_number"
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label  label-bam-trai">Trọng lượng
                                                        tối đa cho
                                                        phép </label>
                                                    <div class="col-md-4">
                                                        <input maxlength="200" type="text"
                                                    ...
                                                    <label class="col-md-2 control-label  label-bam-phải">Tên nhà sản
                                                        xuất và
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label  label-bam-trai">Năm sản
                                                        xuất </label>
                                                    <div class="col-md-4">
                                                        <input maxlength="200" type="text"
                                                    ...
                                                    <label class="col-md-2 control-label  label-bam-phải">Số xuất xưởng
                                                        của nhà
                                                        sản xuất </label>
                                                    <div class="col-md-4">
                                                        <input maxlength="200" type="text"
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label  label-bam-trai">Số hiệu đăng
                                                        ký tại
                                                        Việt Nam</label>
                                                    <div class="col-md-10">
                                                        <input maxlength="200" type="text"
                                        ...
                                        <div class="col-md-12 panel-body "
                                            ...
                                            <div class="bs-example form-horizontal ng-pristine ng-valid">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label  label-bam-trai">Chủ phương
                                                        tiện </label>
                                                    <div class="col-md-10">
                                                        <input maxlength="200" type="text" ng-model="item.owner_info"
                                                               class="form-control">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label  label-bam-trai">Địa chỉ chủ
                                                        phương tiện </label>
                                                    <div class="col-md-10">
                                                        <input maxlength="1000" type="text"
                                                               ng-model="item.owner_info_address"
                                                               class="form-control">
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <label class="col-md-2 control-label  label-bam-trai">Cấp phương
                                                        tiện </label>
                                                    <div class="col-md-4">
                                                        <input maxlength="200" type="text"
                                                    ...
                                                    <label class="col-md-2 control-label  label-bam-phai">Công
                                                        dụng </label>
                                                    <div class="col-md-4">
                                                        <input maxlength="200" type="text"
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label  label-bam-trai">Năm và nơi
                                                        đóng </label>
                                                    <div class="col-md-10">
                                                        <input maxlength="200" type="text"
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label  label-bam-trai">Chiều dài
                                                        thiết kế </label>
                                                    <div class="col-md-4">
                                                        <input maxlength="50" type="text"
                                                    ...
                                                    <label class="col-md-2 control-label  label-bam-phai">Chiều dài lớn
                                                        nhất </label>
                                                    <div class="col-md-4">
                                                        <input maxlength="50" type="text"
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label  label-bam-trai">Chiều rộng
                                                        thiết kế </label>
                                                    <div class="col-md-4">
                                                        <input maxlength="50" type="text"
                                                    ...
                                                    <label class="col-md-2 control-label  label-bam-phai">Chiều rộng lớn
                                                        nhất </label>
                                                    <div class="col-md-4">
                                                        <input maxlength="50" type="text"
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label  label-bam-trai">Chiều cao
                                                        mạn </label>
                                                    <div class="col-md-4">
                                                        <input maxlength="50" type="text"
                                                    ...
                                                    <label class="col-md-2 control-label  label-bam-phai">Chiều
                                                        chìm </label>
                                                    <div class="col-md-4">
                                                        <input maxlength="50" type="text"
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label  label-bam-trai">Mạn
                                                        khô </label>
                                                    <div class="col-md-4">
                                                        <input maxlength="50" type="text"
                                                    ...
                                                    <label class="col-md-2 control-label  label-bam-phai">Vật liệu
                                                        vỏ </label>
                                                    <div class="col-md-4">
                                                        <input maxlength="200" type="text"
