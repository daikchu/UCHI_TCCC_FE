                                ...
                                <li ng-repeat="user in item.persons track by $index">
                                    <div class="treeChild">
                                        ...
                                        <div class="col-md-7 " style="padding-top: 7px">
                                            ...
                                            <select name="type" ng-model="user.template" class="form-control"
                                                    ng-change="changTemplatePrivy(itemIndex,$index,user.template)"
                                                    ng-init="changTemplatePrivy(itemIndex,$index,user.template)">
                                                <option value="">--Chọn--</option>
                                                <option ng-repeat="item in templatePrivys" value="{{item.id}}">{{item.name}}</option>
                                            </select>
                                        ...
                                        <div class="col-md-12 panel-body " >
                                            ...
                                            <div ng-show="user.template==2 && user.myPerson" class="bs-example form-horizontal ng-pristine ng-valid">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label  label-bam-trai">Tìm kiếm</label>
                                                    <div class="col-md-10">
                                                        <input maxlength="100" type="text" class="form-control name" ng-model="user.org_code" placeholder="Nhập mã số thuế để tìm kiếm"
