...
<script src="<%=request.getContextPath()%>/static/js/notarybook/edit.js" type="text/javascript"></script>

<div id="menu-map">
    <a href="#menu-toggle" id="menu-toggle"><img src="<%=request.getContextPath()%>/static/image/menu-icon.png"></a>
    <span id="web-map">Chỉnh sửa sổ <%=congchung%></span>
</div>
<div class="truong-form-chinhbtt" id="NotaryBookController" ng-app="osp" ng-controller="NotaryBookController">
    <div id="uchi-status">
        <c:if test="${item.success == false}">
            <div class="status-error"><img class="status-img" src="<%=request.getContextPath()%>/static/image/error.png">Chỉnh sửa thông tin không thành công!</div>
        </c:if>
    </div>
    <div class="panel-group" id="accordion">
        <div class="form-horizontal">
            <form name="myForm" action="${updateUrl}" method="post" class="panel panel-default" id="panel1">
                <input type="hidden" name="id" id="id" value="${item.id}">
                <input type="hidden" name="lock_day" id="lock_day"
                       value="${item.lock_day}" >
                <div class="panel-heading col-md-12">
                    <div class="col-md-12" style="padding-left: 0px;">
                        <h4 class="panel-title col-md-9" style="padding-left: 0px;">Thông tin sổ công chứng</h4>
                    </div>
                </div>
                    ...
                    <div class="panel-body col-md-12" style="padding-bottom: 0px;margin-bottom: 0px;">
                        <div class="row truong-inline-field">
                            <div class="form-group">
                                <div class="col-md-12">
                                    <label class="col-md-2 control-label label-bam-trai required">Sổ công chứng</label>
                        ...
                        <div class="row truong-inline-field">
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3 control-label label-bam-trai">
                                        <input id="create_date" type="text" class="form-control" autocomplete="off" placeholder="dd/mm/yyyy"
                                               name="create_date" ng-minlength="10" maxlength="10"
                                    ...
                                    <div class="col-md-4 control-label label-bam-trai">
                                        ...
                                        <select class="form-control truong-selectbox-padding select2"
                                                ...
                                                value="${item.status}">
                                            <option value="${Constants.STATUS_NOTARY_BOOK_OPEN}" ${item.status == Constants.STATUS_NOTARY_BOOK_LOCK_UP ?"selected":""}>Mở sổ</option>
                                            <option value="${Constants.STATUS_NOTARY_BOOK_LOCK_UP}" ${item.status == Constants.STATUS_NOTARY_BOOK_LOCK_UP ?"selected":""}>Khóa sổ</option>
                                        </select>
                                        <div style="margin-top: 5px;color: red;"
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Chỉnh sửa thông tin sổ công chứng</h4>
                            </div>
                            <div class="modal-body">
                                <p>Xác nhận chỉnh sửa thông tin sổ công chứng? </p>
                            </div>
                            <div class="modal-footer">
                                <input type="submit" class="btn btn-success" data-dismiss="modal" name="" value="Đồng ý" ng-click="check_add()">
