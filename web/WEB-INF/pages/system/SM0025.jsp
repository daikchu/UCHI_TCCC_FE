...
<spring:url value="/system/osp/contracttemplate-add" var="addUrll"/>
...
<div class="truong-form-chinhds panel-group"  ng-app="osp" ng-controller="contractController">
    <div id="uchi-status">
        <c:if test="${contractTempList.action_status == '1'}">
            <div class="status-success"><img class="status-img" src="<%=request.getContextPath()%>/static/image/success.png">
                Thêm mới Mẫu hợp đồng thành công!
            </div>
        </c:if>
        <c:if test="${contractTempList.action_status == '2'}">
            <div class="status-success"><img class="status-img" src="<%=request.getContextPath()%>/static/image/success.png">
                Cập nhật Mẫu hợp đồng thành công!
            </div>
        </c:if>
        <c:if test="${contractTempList.action_status == '3'}">
            <div class="status-success"><img class="status-img" src="<%=request.getContextPath()%>/static/image/success.png">
                Xóa Mẫu hợp đồng thành công!
            </div>
        </c:if>
        <c:if test="${contractTempList.action_status == '4'}">
    ...
    <form class="form-horizontal" action="${contractTempListUrl}" id="search-frm" method="get">
        ...
        <input type="hidden" name="model_open" id="model_open" value="${contractTempList.model_open}">
        ...
        <div class="col-md-12 truong-margin-footer0px">
            ...
            <div class="truong-button-dong-bo export-button" style="width: 220px !important;margin-left: 5px;">
                <a class="truong-small-linkbt"> <input data-toggle="modal" data-target="#selectUpdateDialog" type="button" class="form-control luu"  name="" value="Cập nhật từng Mẫu HĐ" ></a>
            </div>
            <div class="float-right-button-table"></div>
            <div class="truong-button-dong-bo export-button" style="width: 220px !important;margin-left: 5px;">
                <a class="truong-small-linkbt"> <input data-toggle="modal" data-target="#_updateAllContract" type="button" class="form-control luu"  name="" value="Cập nhật toàn bộ Mẫu HĐ" ></a>
            </div>
            <div class="truong-button-dong-bo export-button" style="width: 220px !important;margin-left: 5px;">
                <a class="truong-small-linkbt" href="${addUrll}"> <input type="button" class="form-control luu"  name="" value="Thêm mới Mẫu Hợp đồng" ></a>
            </div>
            <%
                }
            %>
            <table class="hidden table" style="margin-bottom:0%;" >
                ...
                <tr class="border-table">
                    ...
                    <th class=" ann-title border-table table-giua">Loại Hợp đồng</th>
                ...
                <c:if test="${contractTempList.total > 0}">
                    ...
                    <tr class="table-tr-xam">
                        <td colspan="7"><div class="truong-padding-foot-table"> Tổng số <span style="color:red">${contractTempList.total}</span> dữ
                            liệu</div>
                            <div class="align-phai">
                                ...
                                <c:if test="${contractTempList.page!=1}">
                                    <img onclick="firstPage('0')"
                                         class="pagging-icon"
                                         src="<%=request.getContextPath()%>/static/image/pagging/icon1.png">

                                    <img onclick="previewPage('0')"
                                         class="pagging-icon"
                                         src="<%=request.getContextPath()%>/static/image/pagging/icon2.png">
                                </c:if>
                                ...
                                <c:if test="${contractTempList.page != contractTempList.totalPage}">
                                    <img onclick="nextPage('0')"
                                         class="pagging-icon"
                                         src="<%=request.getContextPath()%>/static/image/pagging/icon8.png">
                                    <img onclick="lastPage('0')"
                                         class="pagging-icon"
                                         src="<%=request.getContextPath()%>/static/image/pagging/icon7.png">
                                </c:if>
                            </div>
            ...
            <table class="table" style="margin-bottom:0%;" id="expandabledatatableCustum">
                <thead>
                    <tr class="border-table">
                        <th colspan="3" class=" ann-title border-table table-giua">Tên hợp đồng</th>
                        <th class=" ann-title border-table table-giua">Loại Hợp đồng</th>
                        <th class=" ann-title border-table table-giua">Trạng thái</th>
                    </tr>
                </thead>
                <tbody class="tbody-expandabledatatableCustum" id="tbody-expandabledatatableCustum">
                    <c:if test="${contractTempList.total > 0}">
                        <c:forEach items="${contractTempList.contractTempListByKindNames}" var="item" varStatus="loop">
                        ...
                        <tr class="table-tr-xam">
                            <td colspan="7"><div class="truong-padding-foot-table"> Tổng số <span style="color:red">${contractTempList.total}</span> dữ liệu</div>
                                <div class="align-phai">
                                    <c:if test="${contractTempList.page==1}">
                                        <img
                                                class="truong-pagging-icon"
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Cập nhật tất cả hợp đồng</h4>
                </div>
                <div class="modal-body">
                    <p>Bạn chắc chắn cập nhật tất cả hợp đồng ? </p>
                    <p style="color: red">Tất cả mẫu hợp đồng sẽ được cập nhật từ sở tư pháp</p>
                </div>
                            ...
                            <table class="table" style="margin-bottom:0%" id="expandabledatatableCustumPopup">
                                ...
                                <tbody class="tbody-expandabledatatableCustumPopup" id="tbody-expandabledatatableCustumPopup">
                                    <c:if test="${contractTempList.total > 0}">
                                        ...
                                        <tr class="table-tr-xam">
                                            <th colspan="7"><div class="truong-padding-foot-table"> Tổng số <span style="color:red">${contractTempList.total}</span> dữ liệu</div>
                                                <div class="align-phai">
                                                    <c:if test="${contractTempList.page==1}">
                                                        <img
                                                                class="truong-pagging-icon"
