...
//            pasteHtmlAtCaret("<span class='inputcontract' editable-text='newtextbox' placeholder='"+ sel.focusNode.data +"' contenteditable='true'></span> ");
            pasteHtmlAtCaret('<span class="inputcontract" editspan="newtextbox" ng-model="" placeholder="..." <!--contenteditable="true"-->>[Giá trị]</span>',el);
        }
        else
            pasteHtmlAtCaret('<span class="inputcontract" editspan="newtextbox" ng-model="" placeholder="..." <!--contenteditable="true"-->>[Giá trị]</span>',el);
        ...
        editable.attachListener(editable, 'click', function (ev) {
            ...
            if (tagName == "SPAN") {
                if (className == "inputcontract" || className == "inputcontract textforcus") {
                    ...
                    var html = '';
                    $("#textboxofp").append('editspan : <input class="idoftextbox" value="' + target.getAttribute("editspan") + '"></input>    Mặc định :<input class="placeholdertext" value="' + target.getAttribute("placeholder") + '"></input> <a class="deleteiteminput btn btn-danger btn-xs" style="float:none;" href="javascript:void(0)">Xóa</a>');
