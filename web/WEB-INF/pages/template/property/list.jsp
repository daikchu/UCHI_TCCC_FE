        ...
        <form class="form-horizontal" action="/template/privy-synch" id="search-frm" method="get" name="myForm">
            ...
            <div class="col-md-12">
                ...
                <table class="table" style="margin-bottom:0%">
                    ...
                    <c:if test="${propertyTemplateList.size() > 0}">
                        <c:forEach items="${propertyTemplateList}" var="item" varStatus="loop">
                            <tr>
                                ...
                                <td class="border-table align-giua" style="min-width: 120px">
                                    <%
                                        if(ValidationPool.checkRoleDetail(request,"29", Constants.AUTHORITY_SUA)){
                                    %>
                                    <a href="<%=request.getContextPath()%>/template/property/edit/${item.id}" class="btn btn-primary btn-xs">Cập nhật</a> /
                                    <%
                                        }
                                    %>
                                    <%
