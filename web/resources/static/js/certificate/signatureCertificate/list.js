myApp.controller('certListController', ['$scope', '$http', '$filter', '$window', '$timeout', '$q', 'fileUpload', function ($scope, $http, $filter, $window, $timeout, $q, fileUpload) {
    $scope.userId = userId;
    ...
    $scope.search = function () {
        // $scope.searchCondition.cert_number = $scope.searchCondition.cert_number.trim();
        $('#search_certNumber').val($scope.searchCondition.cert_number.trim());
