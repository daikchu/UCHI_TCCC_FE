myApp.controller('contractAddController', ['$scope', '$http', '$filter', '$window', '$timeout', '$q', 'fileUpload', function ($scope, $http, $filter, $window, $timeout, $q, fileUpload) {
    ...
    //nếu là chứng thực thì lấy số hợp đồng init
    if (org_type == 1) {
        $scope.getContractNumber();
    }
...
//notary_person
    ...
    $scope.downloadWord = function () {
       ...
       var fileName = "Hop-dong-cong-chung.doc";
       exportHTMLToWord(html, fileName);*/
    };
            ...
            if ($scope.checkDate()) {
                ...
                $http.get(url + "/contract/checkContractNumber", {params: {contract_number: $scope.contract.contract_number}})
                    .then(function (response) {
                        ...
                        } else $("#checkContractNumber").modal('show');
                    });
                                                                ...
                                                                for (var i = 0; i < $scope.privys.privy.length; i++) {
                                                                    ...
                                                                    for (var j = 0; j < item2.persons.length; j++) {
                                                                        ...
                                                                        var listPersonForm = {
                                                                            ...
                                                                            /*05/09/2020 Bổ sung trường tài sản phương tiện vận tài là "Tàu bay" và "Phương tiện thủy nội địa"*/
                                                                            owner_info_address: item4.owner_info_address,
                                                                            airplane_name: item4.vehicle_airplane.airplane_name,
                                                                            airplane_regist_number: item4.vehicle_airplane.airplane_regist_number,
                                                                            airplane_type: item4.vehicle_airplane.airplane_type,
                                                                            airplane_engine_number: item4.vehicle_airplane.airplane_engine_number,
                                                                            airplane_max_weight: item4.vehicle_airplane.airplane_max_weight,
                                                                            airplane_producer: item4.vehicle_airplane.airplane_producer,
                                                                            airplane_year_manufacture: item4.vehicle_airplane.airplane_year_manufacture,
                                                                            airplane_factory_number: item4.vehicle_airplane.airplane_factory_number,
                                                                            airplane_regist_number_vietnam: item4.vehicle_airplane.airplane_regist_number_vietnam,
                                                                            ship_name: item4.vehicle_ship.ship_name,
                                                                            ship_regist_number: item4.vehicle_ship.ship_regist_number,
                                                                            ship_level: item4.vehicle_ship.ship_level,
                                                                            ship_function: item4.vehicle_ship.ship_function,
                                                                            ship_year_place_construction: item4.vehicle_ship.ship_year_place_construction,
                                                                            ship_design_length: item4.vehicle_ship.ship_design_length,
                                                                            ship_max_length: item4.vehicle_ship.ship_max_length,
                                                                            ship_design_height: item4.vehicle_ship.ship_design_height,
                                                                            ship_max_height: item4.vehicle_ship.ship_max_height,
                                                                            ship_width: item4.vehicle_ship.ship_width,
                                                                            ship_dimension_sinking: item4.vehicle_ship.ship_dimension_sinking,
                                                                            ship_freeboard: item4.vehicle_ship.ship_freeboard,
                                                                            ship_hull_material: item4.vehicle_ship.ship_hull_material,
                                                                            /*END Bổ sung trường tài sản phương tiện vận tài là "Tàu bay" và "Phương tiện thủy nội địa"*/
                                                                            type_real_estate: item4.type_real_estate,
                                                                            type_real_estate_sub: item4.type_real_estate_sub
