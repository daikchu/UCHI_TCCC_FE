...
myApp.controller('jspHomeController', ['$scope', '$http', '$filter', '$window', 'fileUpload', '$timeout', '$q', '$interval', function ($scope, $http, $filter, $window, fileUpload, $timeout, $q, $interval) {
